...
import sms from '../assets/projects/meetup/growth/sms.png'
import paywalls from '../assets/projects/meetup/growth/paywalls.png'
      ...
      <div className="project-content">
        ...
        <div className="project-text-container" id="section-1">
          ...
          <div className="project-text">
            <p>
              Meetup is a global platform that enables people to create communities and organize events around shared interests. It's{' '}
              <span className="font-medium">one of the largest event and community platforms</span> globally, with{' '}
              <span className="font-medium">millions of monthly active users</span> worldwide.
            </p>
            <p>
        ...
        <div className="project-text-container" id="section-3">
          ...
          <div className="project-text">
            ...
            <p>
              One initiative focused on <span className="font-medium">SMS reminders</span> for event participants. Event attendance had long been a known
              pain point, with a meaningful share of no-shows attributable to attendees simply forgetting about the event. I therefore explored SMS reminders
              as a way to improve attendance while strengthening organizer–member communication.
            </p>
            <p>
        ...
        <div className="project-text-container" id="section-4">
          ...
          <div className="project-text">
            <p>
              In conclusion, during my active period as a Meetup Product Designer, gross subscription bookings showed strong{' '}
              <span className="font-medium">year-over-year growth</span>, with
              onboarding and paywall experiments delivering meaningful monetization gains across desktop and mobile.
            </p>
            <p>
              ...
              <span className="font-medium">best friendship app</span> by German broadcast company nTV.
            </p>
            <p>
              Together, these changes helped <span className="font-medium">reposition Meetup</span> as a more contemporary product and laid the foundation
